...
result_l_df = pd.DataFrame(columns=['키워드', '점수', '연도', '월', '기사 수', '데이터 출처'])
result_b_df = pd.DataFrame(columns=['키워드', '점수', '연도', '월', '기사 수', '데이터 출처'])
...
# result_l_df.to_csv('lib_data.csv', index=False)
